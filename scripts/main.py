...
def findNearestLinkStation(point: Tuple[int, int]):
...
if __name__ == "__main__":
    findNearestLinkStation((0,0))
    findNearestLinkStation((100,100))
    findNearestLinkStation((15,10))
    findNearestLinkStation((18,18))